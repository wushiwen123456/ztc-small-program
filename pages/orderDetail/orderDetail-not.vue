<template>
	<view class="detail">
		<view class="top">
			<view class="tip">
				<view class="countdown"><img src="../../static/od1.png" alt="">待分享，还差{{content.assemble.can_join}}人</view>
			</view>
			<view class="img">
				<view class="groupImg pin">
					<span class="spell">拼主</span>
					<img :src="content.assemble.master.avatarurl" alt="">
				</view>
				<view class="groupImg" v-if="content.assemble.followers != ''" v-for="(aa,index) in content.assemble.followers" :key="index">
					<img :src="aa.user.avatarurl" alt="">
				</view>
				<view class="groupImg">
					<img src="../../static/nophoto.png" alt="">
				</view>
				<view class="right invite" @tap="detail()">邀请好友</view>
			</view>
		</view>
		<view class="listo">	
		    <view class="title"> 
		...
		<view class="fixedB">
			<span class="invite" @tap="detail()">邀请好友拼团</span>
		</view>
	</view>
</template>
